...
public class QuickCrab extends CrabCritter {
	...
	ArrayList<Location> locs = new ArrayLiist<Location>();
	Grid g = getGrid();

	addIfGoodTwoAwayMove(locs,getDireciton() + Location.LEFT);
	addIfGoodTwoAwayMove(locs,getDireciton() + Location.RIGHT);
